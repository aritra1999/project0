...
function Sidebar(){
    ...
    return (
        <div className="h-screen pt-20 bg-white z-30">
            <div className="border-r border-gray-200 h-full pr-1">
                <div className="pl-1 py-4">
                    <button className="border border-gray-200 text-indigo-600 hover:shadow-md py-4 px-4 rounded-full flex items-center font-semibold" onClick={() => setsendMessage(true)}>
                ...
                <div className="w-full flex items-center hover:bg-gray-100  text-gray-700 rounded-r-full py-2 text-sm px-4 font-medium">
