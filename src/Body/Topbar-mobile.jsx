...
export default function TopBar({title, showBack}) {
    return (
        <div>
            <div className="flex mx-4 px-2 pt-4 pb-4 justify-between border-b border-gray-200">
            ...
            {/* <div className="px-8 pb-4 text-xs text-gray-600 ">Thursday, Nov 19, 3:18 PM</div> */}
            <div className="px-6 flex justify-between items-center">
                <div className="flex items-center">
                    ...
                    <div className="text-sm">
                        <div>
                            <span className="text-gray-500"> aritra041999@gmail.com </span> - an eternity ago.
                        </div>
                        To Me
                    </div>
                </div>
