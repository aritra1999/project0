    ...
    return (
        <div>
            <div className="pl-16 pr-12 py-4 w-full flex justify-between items-center">
                ...
                <div className="h-12 w-12 rounded-full hover:bg-slate-100 flex items-center justify-center">
                    <BsPrinter className="h-5 w-5"/>
                </div>
            </div>
            <div className="px-16 flex justify-between items-center">
                <div className="flex items-center">
                    <div className="h-12 w-12 bg-slate-300 rounded-full flex items-center justify-center mr-6">
                        <BiUser className="h-6 w-6"/>
                    </div>
                    <div className="text-sm">
                        <div>
                            Aritra Mondal - <span className="text-slate-500"> aritra041999@gmail.com </span>
                        </div>
                        To Me
                    </div>
                </div>
                <div className="text-slate-600 flex space-x-8 text-xs items-center">
            ...
            <div className="fixed bottom-4 right-20 flex space-x-6">
                <div className="px-4 py-2 border border-slate-300 bg-white text-slate-500 rounded-md flex items-center">
