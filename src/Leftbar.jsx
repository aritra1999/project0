...
function Sidebar(){
    ...
    return (
        <div className="w-80 h-screen pt-20 bg-white z-30">
            <div className="border-r border-slate-200 h-full pr-4">
                <div className="pl-4 py-4">
                    <button className="border border-slate-200 text-indigo-600 hover:shadow-md py-4 pl-4 pr-6 rounded-full flex items-center font-semibold" onClick={() => setsendMessage(true)}>
                ...
                <div className="w-full flex items-center hover:bg-slate-100  text-slate-700 rounded-r-full py-2 text-sm px-6 font-medium">
            ...
            { sendMessage ? (
            <div className="fixed right-20 bottom-0 z-50 w-1/3 bg-white rounded-t-lg">
            <div className="flex justify-between py-3 px-6 bg-slate-800 text-white border border-slate-800 rounded-t-lg text-sm items-center">
                    <div>New Message</div>
                    <div className="cursor-pointer" onClick={() => setsendMessage(false)}>
                        <MdClose  className="h-4 w-4 cursor-pointer" />
                    </div>
                </div>
                <div className='border-r border-l border-slate-200 pb-3'>
                    ...
                    <button className="mx-3 mt-3 px-6 py-2 bg-blue-600 rounded-md text-white flex items-center ml-auto bottom-0">
                        Send
