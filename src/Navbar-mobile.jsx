...
function Navbar(){
    return (
        <div className="z-40 flex justify-between items-center p-3 border-b border-slate-200 fixed w-screen bg-white">
            <div className="bg-slate-100 py-3 px-4 w-full rounded-lg text-slate-600 text-sm flex justify-between items-center"> 
